...
def file_input_window() -> str:
    file_path = ""
    layout = [[sg.Text("Please Choose a Video File: ", font="ArialBlack 14 bold")],
              [sg.Text("File Path", font="ArialBlack 14 bold"), sg.InputText(key="-FILE_PATH-", size=(50, 4)),
              ...
              [sg.Button("OK", size=(10, 1), font="ArialBlack 16 bold"), sg.Exit()]]
...
def naming_window() -> str:
    name = ""
    layout = [[sg.Text("Please Enter a Name for the Gesture / Pose: ", font="ArialBlack 14 bold")],
              [sg.Text("Name", font="ArialBlack 14 bold"), sg.InputText(key="-NAME-", size=(50, 4))],
              [sg.Button("OK", size=(10, 1), font="ArialBlack 16 bold"), sg.Exit()]]
    ...
    while True:
        ...
        if event == "CLOSE" or event == sg.WIN_CLOSED:
            ...
            sg.popup("","User can record a gesture/pose live via webcam, or can import an existing video containing the part of the gesture/pose. \n",
                     font="ArialBlack 14", keep_on_top=True)
        elif event == "anno2":
            ...
            if values["-Import_Video-"]:
                ...
                if file_path == "":
                    sg.popup("", "Please choose a video file!", font="ArialBlack 14", keep_on_top=True)
                    continue
            ...
            name = naming_window()
            if name == "":
                sg.popup("", "Please enter a name for the gesture / pose!", font="ArialBlack 14", keep_on_top=True)
                continue
